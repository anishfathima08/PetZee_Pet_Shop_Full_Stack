        ...
        <>
            <div>
                ...
                <div className='px-5 lg:px-20 pt-24'>
                    <div className='text-center text-3xl md:text-5xl lg:text-5xl h-[8vh] font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500'>
                        <p>🐾 Contact Us 🐾</p>
                    </div>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 px-5 py-8 lg:px-20 lg:py-14'>
                    ...
                    <div className='shadow-lg bg-gray-100 rounded-lg p-4 lg:p-8 md:p-8'>
                        ...
                        <div className='flex justify-center'>
                            <button className='btn btn-wide bg-gradient-to-r from-indigo-500 to-purple-500 hover:shadow-inner hover:bg-none hover:bg-gray-200 text-white border-none hover:text-gray-800'>Send Message</button>
                        </div>
                    </div>
                ...
                <div className='px-5 lg:px-20 pb-8 lg:pb-14'>
                    <iframe className='w-full h-[350px]' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3506.29617161595!2d77.18217857528401!3d28.50073567573695!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d1fabe604b215%3A0xa4da693f05955d99!2sPetzee%20Pet%20Food!5e0!3m2!1sen!2sin!4v1734660986848!5m2!1sen!2sin" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"/>
                </div>
