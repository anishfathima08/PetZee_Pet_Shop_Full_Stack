    ...
    <div className="flex h-screen">
      ...
      <div className="lg:w-1/4 xl:w-1/5 md:w-1/3 hidden shadow-xl p-4 lg:flex md:flex flex-col items-center">
        ...
        <div className="w-full">
          ...
          <button onClick={() => setSelectedSection('editProfile')} className='text-start block w-full py-2 px-4 text-lg mb-4 hover:font-semibold text-white bg-gradient-to-r from-indigo-500 to-purple-500 shadow-xl'>
          <i className="ri-user-settings-line mr-2"></i>Edit Profile
          </button>
          <Link to='/home'>
            <button className="text-start block w-full py-2 px-4 text-lg mb-4 hover:font-semibold text-white bg-gradient-to-r from-indigo-500 to-purple-500">
