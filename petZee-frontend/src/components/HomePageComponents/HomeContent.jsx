            ...
            <div className='px-5 py-5 lg:px-20 grid lg:grid-cols-2 gap-10 md:px-10'>
                ...
                <div className='py-0'>
                    ...
                    <div className="flex items-center">
                        <p className="lg:text-3xl md:text-3xl text-2xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500 relative bottom-1 leading-none">Join the PetZee Zone,
                    ...
                    <p className="lg:text-lg md:text-lg text-gray-600 lg:hidden xl:block">
                        At PetZee, we’re more than just a pet store – we’re a vibrant and supportive community of passionate pet lovers, dedicated to enhancing the lives of our furry, feathery, and scaly friends. From expert advice and guidance to exclusive offers and events, we ensure that you and your pet are always supported in every way possible. With PetZee, you’re not just shopping – you’re investing in a happier, more fulfilling life for your pet, surrounded by a caring and passionate network of fellow pet lovers.
                    </p>
