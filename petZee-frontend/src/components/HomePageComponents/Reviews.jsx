    ...
    return (
        <>
            ...
            <div className='lg:px-20 px-5 pt-10'>
                ...
                <div className='text-center py-5 text-3xl md:text-5xl lg:text-5xl lg:h-[100px] md:h-[12vh] font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500'>
                ...
                <div className='lg:flex md:flex justify-between items-center bg-gray-100 p-5 mt-8 mb-5'>
                    ...
                    <div className='flex justify-center'>
                        <button className='btn lg:rounded-s-badge md:rounded-s-badge lg:mt-0 md:mt-0 mt-5 bg-gradient-to-r from-[#6368d2] to-purple-500 shadow-inner hover:bg-none  hover:bg-gray-200 text-white hover:text-gray-800 border-0'>Review us on Google</button>
                    </div>
                </div>                   
