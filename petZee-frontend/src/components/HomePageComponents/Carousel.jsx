            ...
            <SwiperSlide key={index}>
              <div className="relative md:pt-20 lg:pt-0">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-start lg:px-16 md:px-12" >
                  <p className="xl:text-6xl lg:text-4xl md:text-3xl font-bold bg-gradient-to-r from-indigo-500 to-purple-500 bg-clip-text text-transparent">
                    Experience the Magic <br /> of Unconditional Love
                  </p>
                  <p className="lg:text-lg md:text-sm text-gray-800 py-6">
                    Explore a world of furry friends. <br /> At PetZee, we celebrate the joy of pets <br /> and their unconditional love for you.
                  </p>
                  <Link to={'/shop/cat'}>
                    <button className="px-6 py-2 md:btn-xl bg-gradient-to-r from-indigo-500 to-purple-500 hover:bg-gray-300 hover:bg-none text-white hover:text-gray-800 font-semibold rounded-full">
                      Discover More
                    </button>
                  </Link>
                </div>
              ...
              <div className="relative mt-20">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-start pl-4">
                  ...
                  <p className="text-gray-800 py-3">
                    Explore with furry friends. <br /> At PetZee, we celebrate the <br /> joy of pets.
                  </p>
                  <Link to={'/shop/cat'}>
                    <button className="btn-sm bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold rounded-full">
                      Discover More
                    </button>
                  </Link>
                </div>
