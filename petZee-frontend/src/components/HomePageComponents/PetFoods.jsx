    ...
    return (
        <>
            <div className='lg:px-20'>
                <div className='text-center pb-5 text-3xl md:text-5xl lg:text-5xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500'>
                    <p>🐾 PetZee Foods 🐾</p>
                </div>
                <Swiper
                modules={[Autoplay]}
                        ...
                        <div className="m-5 shadow-lg rounded-lg overflow-hidden group hover:translate-y-[-10px] transition-all duration-300 ease-in-out">
                            <div className="relative">
                                ...
                                <div className="absolute my-2 top-4 right-2 text-xl opacity-0 translate-y-10 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 delay-100">
                                    <i className={`ri-heart-3-line rounded-full w-11 h-11 flex items-center justify-center cursor-pointer hover:bg-gradient-to-r from-indigo-500 to-purple-500 hover:text-white ${
                                ...
                                <div className="absolute top-16 right-2 mt-4 text-xl opacity-0 translate-y-10 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 delay-200">
                                    <i className={`ri-shopping-cart-2-line rounded-full w-11 h-11 flex items-center justify-center cursor-pointer hover:bg-gradient-to-r from-indigo-500 to-purple-500 hover:text-white ${
                            ...
                            <div className="p-4">
                                ...
                                <div className="flex justify-between items-center">
                                    <button
                                    className="mt-4 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-lg px-6 py-2 shadow-md transition-all duration-300 hover:bg-gray-300 hover:bg-none hover:text-gray-800 hover:shadow-lg"
