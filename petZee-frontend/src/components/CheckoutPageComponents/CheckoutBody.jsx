...
import { AppContext } from '../../context/AppContextProvider';
 ...
 const OrderConfirmationPage = () => {
  ...
  return (
    <div className="pt-28">
      <div className="text-2xl md:text-5xl lg:text-5xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-indigo-500 text-center lg:h-[8vh]">
