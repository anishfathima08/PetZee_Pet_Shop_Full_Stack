      ...
      <div className='w-[95%] lg:mx-9 md:mx-5 mx-2 px-6 py-2 bg-white bg-opacity-30 backdrop-blur-xl rounded-3xl shadow-lg fixed top-3 z-10'>
        ...
        <div className="flex justify-between items-center">
            ...
            {!MenuOpen &&(
              <div className="font-bold text-xl cursor-pointer">
                <div className="flex items-center mt-2">
                    <Link to={'/home'} className="text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500 relative bottom-2 leading-none">
                    PetZee
                    <span className="absolute w-10 h-8 bg-purple-900 rounded-full bottom-0 -right-2 blur-md opacity-40"></span>
                    <span className="absolute rounded w-16 h-[3px] bg-gradient-to-r from-indigo-500 to-purple-500 -bottom-1 left-0 transform -skew-x-10 "></span>
                  </Link>
                </div>
              </div>
            )}
          ...
          <div className='lg:pl-16 xl:pl-48 lg:inline md:inline hidden '>
            ...
            <NavLink to="/home" className={({ isActive }) => `py-2 mx-1 lg:px-6 md:px-2 rounded-full hover:bg-gradient-to-r from-indigo-500 to-purple-500 ${isActive
              ? "bg-gradient-to-r from-indigo-500 to-purple-500 text-white"
              : "hover:text-white"}`}>
              Home
            </NavLink>

            <NavLink to="/about" className={({ isActive }) => `py-2 lg:px-6 md:px-2 rounded-full hover:bg-gradient-to-r from-indigo-500 to-purple-500 ${isActive
              ? "bg-gradient-to-r from-indigo-500 to-purple-500 text-white"
              : "hover:text-white"}`}>
              About
            </NavLink>

            <NavLink to="/shop/cat" className={({ isActive }) => `py-2 mx-1 lg:px-6 md:px-2 rounded-full hover:bg-gradient-to-r from-indigo-500 to-purple-500 ${isActive
              ? "bg-gradient-to-r from-indigo-500 to-purple-500 text-white"
              : "hover:text-white"}`}>
              Cats
            </NavLink>

            <NavLink to="/shop/dog" className={({ isActive }) => `py-2 lg:px-6 md:px-2 rounded-full hover:bg-gradient-to-r from-indigo-500 to-purple-500 ${isActive
              ? "bg-gradient-to-r from-indigo-500 to-purple-500 text-white"
              : "hover:text-white"}`}>
              Dogs
            </NavLink> 

            <NavLink to="/contact" className={({ isActive }) => `py-2 mx-1 lg:px-6 md:px-2 rounded-full hover:bg-gradient-to-r from-indigo-500 to-purple-500 ${isActive
              ? "bg-gradient-to-r from-indigo-500 to-purple-500 text-white"
              : "hover:text-white"}`}>
              Contact
            </NavLink>
          ...
          <div className='hidden lg:flex md:flex gap-3 justify-end items-center'>
            ...
            <div className='cursor-pointer flex items-center '>
              ...
              <div className="relative lg:mx-5 md:mx-3">
                ...
                {wishlist.length > 0 && (
                  <span className="absolute -top-3 -right-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-xs font-semibold rounded-full w-5 h-5 flex items-center justify-center">
            ...
            {/* LOGOUT BTN */}
            <div>
              <button className='flex gap-1 rounded-full text-white bg-gradient-to-r from-indigo-500 to-purple-500 hover:bg-gradient-to-l px-4 py-2'>
        ...
        {MenuOpen && (
          <div className="lg:hidden md:hidden flex flex-col "> 
            ...
            <div className='flex flex-col my-5'>
              <NavLink to="/home" className={({ isActive }) => `py-2 px-6 rounded-full hover:bg-gradient-to-r from-indigo-500 to-purple-500 ${isActive
                ? "bg-gradient-to-r from-indigo-500 to-purple-500 text-white"
                : "hover:text-white"}`}>
                Home
              </NavLink>

              <NavLink to="/about" className={({ isActive }) => `py-2 px-6 rounded-full hover:bg-gradient-to-r from-indigo-500 to-purple-500 ${isActive
                ? "bg-gradient-to-r from-indigo-500 to-purple-500 text-white"
                : "hover:text-white"}`}>
                About
              </NavLink>

              <NavLink to="/shop/cat" className={({ isActive }) => `py-2 px-6 rounded-full hover:bg-gradient-to-r from-indigo-500 to-purple-500 ${isActive
                ? "bg-gradient-to-r from-indigo-500 to-purple-500 text-white"
                : "hover:text-white"}`}>
                Cats
              </NavLink>

              <NavLink to="/shop/dog" className={({ isActive }) => `py-2 px-6 rounded-full hover:bg-gradient-to-r from-indigo-500 to-purple-500 ${isActive
                ? "bg-gradient-to-r from-indigo-500 to-purple-500 text-white"
                : "hover:text-white"}`}>
                Dogs
              </NavLink> 

              <NavLink to="/contact" className={({ isActive }) => `py-2 px-6 rounded-full hover:bg-gradient-to-r from-indigo-500 to-purple-500 ${isActive
                ? "bg-gradient-to-r from-indigo-500 to-purple-500 text-white"
                : "hover:text-white"}`}>
                Contact
              </NavLink>
                    ...
                    return (
                      <div key={index} className="bg-white shadow-lg rounded-lg overflow-hidden group hover:translate-y-[-10px] transition-all duration-300 ease-in-out">
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex justify-between items-center">
                            <button className="mt-4 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-lg px-6 py-2 shadow-md transition-all duration-300 hover:bg-gray-300 hover:bg-none hover:text-gray-800 hover:shadow-lg" onClick={() => setSelectedItem(data)} >
                              Shop Now
                            </button>
                    ...
                    {wishlistNotification && (
                      ...
                      <div className="grid lg:grid-cols-2 md:grid-cols-2 lg:gap-10 gap-5 mt-5">
                        ...
                        <div>
                          ...
                          <div>
                            <button className='bg-gradient-to-r from-indigo-500 to-purple-500 text-white px-5 py-2 rounded cursor-pointer hover:bg-gray-300 hover:bg-none hover:text-gray-800 shadow-inner transition duration-300' onClick={handleAddToCart}>Add to Cart</button>
                          </div>
              ...
              <> 
                ...
                <div className="flex items-center sticky top-0 bg-white z-10 py-3">
                  <div className="flex items-center">
                    <span className="font-semibold text-xl text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500">Shopping Wishlist</span>
                    {wishlist.length > 0 && (
                      <span className="relative -top-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-xs font-semibold rounded-full w-5 h-5 flex items-center justify-center">{wishlist.reduce((total, item) => total + item.quantity, 0)}</span>
                    )}
                  </div>
                ...
                <div className="flex flex-col h-screen px-1">
                  ...
                  <div className="flex items-center sticky top-0 bg-white z-10">
                    <div className="flex items-center">
                      <span className="font-semibold text-xl text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500">Shopping Wistlist</span>
                      {cart.length > 0 && (
                        <span className="relative -top-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-xs font-semibold rounded-full w-5 h-5 flex items-center justify-center">
                          {cart.reduce((total, item) => total + item.quantity, 0)}
                        </span>
                      )}
                    </div>
                  ...
                  <div className="sticky bottom-0 z-10 py-4">
                    <div className="mt-6 flex gap-5">
                      <Link to="/wishlist" className="text-center btn-block bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-lg px-6 py-3 hover:bg-gradient-to-l transition duration-300">Browse Wishlist</Link>
                    </div>
                  </div>
          ...
          <div className="menu bg-white text-base-content shadow-lg rounded-b-lg min-h-full xl:w-1/4 lg:w-1/3 md:w-1/2 w-full p-4">
            ...
            {cart.length === 0 ? (
              <>
                ...
                <div className="flex items-center sticky top-0 bg-white z-10 py-3">
                  <div className="flex items-center">
                    <span className="font-semibold text-xl text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500">Shopping Cart</span>
                    {cart.length > 0 && (
                      <span className="relative -top-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-xs font-semibold rounded-full w-5 h-5 flex items-center justify-center">{cart.reduce((total, item) => total + item.quantity, 0)}</span>
                    )}
                  </div>
              ...
              <div className="flex flex-col h-screen px-1">
                    ...
                    <div key={index} className="grid grid-cols-3 gap-4 overflow-hidden">
                      ...
                      <div className="space-y-2 my-3 2xl:ml-4 xl:ml-8 lg:ml-4 md:ml-8 ml-4 w-40">
                        ...
                        <div className="flex items-center border w-fit">
                          <button onClick={() => updateQuantity(item._id, 'decrease')} className="hover:bg-gradient-to-r from-indigo-500 to-purple-500 hover:text-white w-8 h-8"><i className="ri-subtract-line"></i></button>
                          <input type="text" value={item.quantity} className="text-center w-10 h-8 focus:outline-none" readOnly />
                          <button onClick={() => updateQuantity(item._id, 'increase')} className="hover:bg-gradient-to-r from-indigo-500 to-purple-500 hover:text-white w-8 h-8"><i className="ri-add-line"></i></button>
                        </div>
                      </div>
                ...
                <div className="sticky bottom-0 z-10 pt-6 pb-4">
                  ...
                  <div className="mt-6 flex gap-5">
                    <Link to="/cart" className="text-center btn-block bg-gradient-to-r from-indigo-500 to-purple-500 text-white px-6 py-3 hover:bg-gradient-to-l transition duration-300">View Cart</Link>
                    <Link to="/checkout" className="text-center btn-block bg-gradient-to-r from-indigo-500 to-purple-500 text-white px-6 py-3 hover:bg-gradient-to-l transition duration-300">Proceed</Link>
                  </div>
                </div>
