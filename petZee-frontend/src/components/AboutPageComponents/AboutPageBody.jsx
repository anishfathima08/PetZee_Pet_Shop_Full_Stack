    ...
    return (
        <>
            ...
            <div className='px-5 lg:px-24 pt-16 lg:pt-20'>
                <div className='text-center text-3xl md:text-5xl lg:text-5xl pt-8 lg:py-10 h-[13vh] font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500'>
                    <p>🐾 About Us 🐾</p>
                </div>
                <div className='grid lg:grid-cols-2 gap-10 py-5 lg:py-14'>
                    ...
                    <div className='lg:py-6'>
                        ...
                        <div className="flex items-center">
                            <p className="text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500 relative bottom-1 leading-none">At PetZee,
                        ...
                        <p className='text-lg my-3'>We understand the unique bond between pets and their owners, and we strive to bring you only the best in pet care, ensuring safety, comfort, and fun for your furry friends. Whether you're a cat lover, dog enthusiast, or anything in between, Petzee is here to enhance your pet’s life with products that are both practical and fun.</p>
                        <p className='text-lg'>Join us at Petzee, where your pet’s happiness is our priority!</p>
            ...
            <div className='p-5 lg:px-20 lg:py-10'>
                <div className='text-center text-3xl md:text-5xl lg:text-5xl pb-10 lg:pb-14 font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500'>
                    <p>🐾Our Services🐾</p>
                </div>
            ...
            <div className="px-5 lg:px-40 py-8 lg:py-14">
                <div className='text-center text-4xl md:text-5xl lg:text-5xl pb-8 lg:pb-14 font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500'>
                    <p>🐾 FAQs 🐾</p>
                </div>
