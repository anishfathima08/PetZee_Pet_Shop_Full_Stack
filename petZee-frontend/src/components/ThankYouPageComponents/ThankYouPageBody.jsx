    ...
    <div className="pt-28">
      ...
      <div className="mx-5 my-12 rounded-lg shadow-xl max-w-xl lg:mx-auto md:mx-auto">
        ...
        <div className="text-center py-8">
          <button onClick={() => window.location.href = '/my-orders'} className="bg-gradient-to-r from-indigo-500 to-purple-500 text-white px-8 py-3 rounded-badge hover:bg-gradient-to-l transition duration-300">
            View Orders
          </button>
        </div>
