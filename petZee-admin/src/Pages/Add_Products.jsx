  ...
  return (
    <div>
      <form className="flex flex-col gap-5" onSubmit={handleFormSubmit}>
        ...
        <button type="submit" className="my-10 p-3 w-[max(40vw,200px)] text-lg text-white bg-gradient-to-r from-indigo-500 to-purple-500 shadow-xl hover:bg-gradient-to-l">
          Add
        </button>
