              ...
              data.map((product, index) => (
                <tbody key={index}>
                  <tr className="border-b border-indigo-500">
                    ...
                    <td className="py-3 lg:px-3 px-5">
                      <button className='text-white py-1 px-3 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500' onClick={() => handleUpdateModal(product)}>
                        Update
                      </button>
                    </td>
      ...
      <dialog id="update_modal" className="modal">
        <div className="modal-box p-6 rounded-lg shadow-lg bg-white">
          <form onSubmit={handleUpdateProduct}>
            ...
            <button type="submit" className="mt-8 p-3 w-[max(40vw,200px)] text-lg text-white bg-gradient-to-r from-indigo-500 to-purple-500 shadow-xl hover:bg-gradient-to-l">
              Update
            </button>
          </form>
        </div>
